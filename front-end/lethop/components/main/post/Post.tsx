...
export default function Post({ post }: { post: PostProps }) {
  ...
  return (
    <div className=" flex flex-col gap-y-6	border p-4 rounded-lg shadow-md bg-white-2 my-8 flex font-custom">
    ...
    width={600}
      ...
      <p className="mb-2 whitespace-pre-line">{toggleText? post.textLines : post.textLines.slice(0, 200)}</p>
      <button className="text-blue-500 text-left font-bold" onClick={handleText}> {toggleText? "إخفاء" : "اكمل القراءة"}</button>
      <div className="flex items-center justify-between mt-4">
        <div className="flex gap-x-6 text-gray-500 hover:text-gray-700 font-bold">
